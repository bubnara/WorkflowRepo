...
The two models created above together hold extensive power in predicting when Capital Bikeshare should be deploying their bikes for optimal use and warehousing. 
...
The second model, which uses a multiple linear regression format, maintains an adjusted r-squared value of ~.816
